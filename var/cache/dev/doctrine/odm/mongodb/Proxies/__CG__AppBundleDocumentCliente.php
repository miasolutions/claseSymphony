 ...
 */
class Cliente extends \AppBundle\Document\Cliente implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'nombre', 'apPaterno', 'apMaterno', 'email', 'celular', 'sexo', 'edad', 'proyectos'];
        }
