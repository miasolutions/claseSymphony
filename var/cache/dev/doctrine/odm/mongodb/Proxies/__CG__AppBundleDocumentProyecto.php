 ...
 */
class Proyecto extends \AppBundle\Document\Proyecto implements \Doctrine\ODM\MongoDB\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'nombre', 'descripcion', 'precio', 'cliente'];
        }
